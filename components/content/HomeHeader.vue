<!-- This is useful if using YAML, and instead of lot, using {{ title }} -->
<!-- <script setup>
defineProps({
    title: {
        type: String,
    ...
    <div>
        <header class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-32 relative">
            <div class="text-center relative">
                <h1>
                    <div  class="font-rubik font-black text-yellow-200 text-4xl sm:text-5xl md:text-6xl glow-yellow-txt">
                        <slot name="title"/>
                    </div>
                </h1>
                <p>
